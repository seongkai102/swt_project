...
def main():
    ...
    def random_team():
        try:
            ...
            for idx, team_a in enumerate(team):
                output_area.insert(tk.END, f"{idx+1}팀: {', '.join(team_a)}\n")
        except Exception as e:
    ...
    def recommend_places():
        try:
            ...
            for place, capacities in teammate.recommend().items():
                output_area.insert(
